...
export default function LeaseAgreementsPage() {
  ...
  const getEmptyStateMessage = () => {
    switch (selectedTab) {
      ...
      case 'active':
        return 'Active leases will appear here once they are activated';
      case 'past':
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => navigate('/dashboard/landlord-applications')}>
                  ...
                  <CardContent>
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-lg">
                        ...
                        <Button variant="outline" size="sm" onClick={() => navigate('/dashboard/landlord-messages')}>
                          Contact
                        </Button>
                      </div>
