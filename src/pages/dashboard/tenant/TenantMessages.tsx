    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Contact a landlord from a property listing to start
        </p>
      </div>
    );
  }
        ...
        return (
          ...
          >
            <Avatar className="h-10 w-10 shrink-0">
              ...
              <AvatarFallback>
                {landlord?.fullName?.split(' ').map(n => n[0]).join('').slice(0, 2) || 'LL'}
              </AvatarFallback>
            </Avatar>
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-2">
                <p className="font-medium truncate">{landlord?.fullName || 'Landlord'}</p>
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 p-4 border-b">
        <Avatar className="h-10 w-10">
          <AvatarImage src={conversation.landlord.avatar || undefined} />
          <AvatarFallback>
            {conversation.landlord.fullName?.split(' ').map(n => n[0]).join('').slice(0, 2)}
          </AvatarFallback>
        </Avatar>
        <div className="flex-1 min-w-0">
          <p className="font-medium">{conversation.landlord.fullName}</p>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Communicate with landlords about properties
        </p>
      </div>
